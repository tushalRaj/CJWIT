...
// mobile number show
$('#mobmainbox1').click(function(e) {
    e.preventDefault()
    $('.mob-main-1').addClass('active')

})
$('#mobmainbox2').click(function(e) {
    e.preventDefault()
    $('.mob-main-2').addClass('active')
})
$('#mobmainbox3').click(function(e) {
    e.preventDefault()
    $('.mob-main-3').addClass('active')
})